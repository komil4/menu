  ...
  List<DishGroup> menu = [
    ...
    DishGroup(
        ...
        dishes: [
          Dish(
              title: 'Soup 1',
              image: 'https://hips.hearstapps.com/hmg-prod/images/best-soup-recipes-1660232265.jpeg'),
          Dish(
              title: 'Soup 2',
              image: 'https://img.taste.com.au/JvrmexiB/taste/2016/11/speedy-tuscan-white-bean-soup-111016-1.jpg'),
          Dish(
              title: 'Soup 3',
          ...
          Dish(
              title: 'Soup 4',
              image: 'https://static01.nyt.com/images/2017/01/11/dining/11SOUP1/11SOUP1-superJumbo.jpg'),
        ]
    ),
    DishGroup(
        title: 'Main course',
    ...
    DishGroup(
        ...
        dishes: [
          ...
          Dish(
              title: 'Fish',
              image: 'https://storcpdkenticomedia.blob.core.windows.net/media/recipemanagementsystem/media/recipe-media-files/recipes/retail/x17/17244-caramel-topped-ice-cream-dessert-760x580.jpg?ext=.jpg'),
          Dish(
              title: 'Burger',
